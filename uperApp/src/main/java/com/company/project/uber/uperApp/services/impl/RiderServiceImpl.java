...
import com.company.project.uber.uperApp.entities.*;
...
import com.company.project.uber.uperApp.strategies.RideStrategyManager;
...
public class RiderServiceImpl implements RiderService {
    ...
    public RideRequestDto requestRide(RideRequestDto rideRequestDto) {
        ...
        RideRequest savedRideRequest = rideRequestRepositories.save(rideRequest);
...
//        TODO : Send notification to all the drivers about this ride request
    ...
    public Rider getCurrentRider() {
        ...
        return riderRepositories.findByUser(user).orElseThrow(() -> new ResourceNotFoundException(
